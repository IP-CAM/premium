...
$("#zoom_03").bind("click", function(e) {  
  ...
  return false;
    ...
    <div class="right">
	<div class="pay-img-product"><img src="/catalog/view/theme/premium/image/webmoney.png">
<img src="/catalog/view/theme/premium/image/yandex.png"><img src="/catalog/view/theme/premium/image/sberbank.png">
<img src="/catalog/view/theme/premium/image/kiwi.png"><img src="/catalog/view/theme/premium/image/privat24.png"></div>
...
<div class="quantity"><?php echo $text_qty; ?>
      ...
      <div class="review">
        <div><img src="catalog/view/theme/premium/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
      </div>
      <?php } ?>
